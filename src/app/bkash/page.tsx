  ...
  return (
    <header className="flex justify-center items-center px-4 py-3">
      <Image
        src={bkashLogo}
        alt="bkash"
        className="mx-auto w-[240px] h-[65px]"
      />
    </header>
  );
};
      ...
      <form className="text-center" onSubmit={handleSubmit}>
        <div className="mb-4 text-center">
          ...
          <input
            ...
            ref={inputRef}
            className="px-3 py-2 my-2 w-full text-base leading-6 bg-white rounded transition-shadow cursor-text duration-[0.3s] ease-[ease-in-out] overflow-x-clip overflow-y-clip"
        ...
        <div className="flex justify-center mt-4 text-center ">
          ...
          >
            {pending ? (
              <ScaleLoader color="#991b1b" className="text-sm w-4 h-4 " />
            ) : (
              "Submit"
            )}
          </button>
